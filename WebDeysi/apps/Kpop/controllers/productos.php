...
importar('apps/kpop/models/productos');
importar('apps/kpop/views/productos');
importar('apps/kpop/views/mensajes');
...
class ProductosController extends Controller  {
    ...
    public function agregar(){
        ...
        $sql = "SELECT id, CONCAT(primerapellido,' ', segundoapellido, ' ',
            nombres) as nombres FROM trabajadores";
        $trabajadores = $this->model->query($sql);
        $this->view->agregar($trabajadores, $clasificaciones);
    }
    ...
    public function guardar(){
       ...
       $trabajadores_id      = $_POST['trabajadores_id']??0;
       ...
       //--- asociar al modelo
        ...
        $this->model->trabajadores_id      = $trabajadores_id;
    ...
    public function eliminar($id){
        ...
        HTTPHelper::go("/kpop/productos/listar");
    }
